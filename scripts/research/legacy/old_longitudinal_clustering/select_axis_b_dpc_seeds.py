...
from dpc_initialize_clusters import DPCResult, _linear_percentile, dpc_init
SLOPE_PATH = ROOT / "data" / "legacy" / "old_longitudinal_clustering" / "axis_b_adas13_slopes.csv"
K_SELECTION_PATH = ROOT / "data" / "legacy" / "old_longitudinal_clustering" / "axis_b_nbclust_k_selection.json"
AXIS_A_DPC_PATH = ROOT / "scripts" / "research" / "study_entry" / "dpc_initialize_clusters.py"
OUTPUT_PATH = ROOT / "data" / "legacy" / "old_longitudinal_clustering" / "axis_b_dpc_seed_selection.json"
