"""Run the first complete enhanced Axis A K-Means experiment.
...
DPC_CENTROIDS_PATH = INTERIM / "axis_a_dpc_selected_centroids.csv"

ASSIGNMENTS_PATH = INTERIM / "axis_a_enhanced_assignments.csv"
CENTROIDS_PATH = INTERIM / "axis_a_enhanced_centroids.csv"
METRICS_PATH = INTERIM / "axis_a_enhanced_metrics.csv"
RUN_SUMMARY_PATH = INTERIM / "axis_a_enhanced_run_summary.csv"
REPRODUCIBILITY_PATH = INTERIM / "axis_a_enhanced_reproducibility.csv"
...
def write_outputs(
    ...
    summary: list[tuple[str, Any]] = [
        ("pipeline", "axis_a_enhanced_kmeans"),
