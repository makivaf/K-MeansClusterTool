"""Audit the ADNI1--ADNI3 Axis A scope and NPI-Q study-entry coverage.

The existing Axis A analytical table is read but never modified. This script
...
AXIS_A_PATH = INTERIM / "axis_a_study_entry_unimputed.csv"
...
def main() -> None:
    ...
    scope_audit.to_csv(INTERIM / "axis_a_scope_restricted_missingness.csv", index=False, encoding="utf-8")
    ...
    preview.to_csv(INTERIM / "axis_a_final_exclusion_preview.csv", index=False, encoding="utf-8")
