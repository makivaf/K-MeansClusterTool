"""Reconcile Axis B longitudinal phase and record ambiguities without modeling.
...
ROSTER_PATH = ROOT / "data" / "interim" / "axis_a_study_entry_unimputed.csv"
PRIOR_AUDIT_PATH = ROOT / "data" / "interim" / "axis_b_adas_longitudinal_audit.json"
OUTPUT_PATH = ROOT / "data" / "interim" / "axis_b_longitudinal_methodology_reconciliation.json"
...
def main() -> None:
    ...
    if before_hashes != after_hashes:
        raise AssertionError("A source or primary Axis A artifact changed during reconciliation")
    print(json.dumps({
