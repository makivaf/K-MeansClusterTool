"""SOP 3: deterministic density-peak centroid initialization for Axis A.
...
SCORES_PATH = INTERIM / "axis_a_dpc_scores.csv"
CENTROIDS_PATH = INTERIM / "axis_a_dpc_selected_centroids.csv"
SUMMARY_PATH = INTERIM / "axis_a_dpc_summary.csv"
DETERMINISM_PATH = INTERIM / "axis_a_dpc_determinism_check.csv"
...
def load_axis_a_inputs() -> tuple[list[str], list[str], list[tuple[float, ...]], int]:
...
def main() -> None:
    ptids, rids, matrix, selected_k = load_axis_a_inputs()
