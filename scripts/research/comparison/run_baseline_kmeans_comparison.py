"""Run the locked 30-replication random-initialization K-Means baseline.
...
K_SELECTION_PATH = INTERIM / "baseline_kmeans_k_selection.csv"
RUNS_PATH = INTERIM / "baseline_kmeans_runs.csv"
ASSIGNMENTS_PATH = INTERIM / "baseline_kmeans_assignments.csv"
SUMMARY_PATH = INTERIM / "baseline_kmeans_summary.csv"
STABILITY_PATH = INTERIM / "baseline_kmeans_stability.csv"
CUMULATIVE_QC_PATH = INTERIM / "baseline_kmeans_cumulative_qc.csv"
COMPARISON_PATH = INTERIM / "baseline_vs_enhanced_metrics.csv"
