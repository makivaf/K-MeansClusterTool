"""Preprocess the locked ADNI1--ADNI3 Axis A cohort and apply SOP 1 PCA.
...
AUTHORITATIVE_INPUT = INTERIM / "axis_a_study_entry_unimputed.csv"
SCOPE_AUDIT = INTERIM / "axis_a_scope_restricted_missingness.csv"
...
OUTPUT_PATHS = {
    "unimputed": INTERIM / "axis_a_retained_unimputed.csv",
    "imputed": INTERIM / "axis_a_imputed.csv",
    "standardized": INTERIM / "axis_a_standardized.csv",
    "scores": INTERIM / "axis_a_pca_scores.csv",
    "variance": INTERIM / "axis_a_pca_explained_variance.csv",
    "loadings": INTERIM / "axis_a_pca_loadings.csv",
    "summary": INTERIM / "axis_a_preprocessing_summary.csv",
}
...
def build_axis_a_retained_table(source: pd.DataFrame) -> pd.DataFrame:
...
def write_outputs(
    ...
    """Write only the seven requested Axis A preprocessing deliverables."""
...
def main() -> None:
    ...
    retained = build_axis_a_retained_table(source)
